...
enum AppConfig {
    ...
    static let legacyGenerationBackendKey = "eison.generation.backend"
    static let appGenerationBackendKey = "eison.generation.app.backend"
    static let extensionGenerationBackendKey = "eison.generation.extension.backend"
    ...
    static let mlxDownloadDeepLinkHost = "mlx-download"
    static let mlxDownloadDeepLinkRepoQueryItem = "repo"
    static let mlxDownloadDeepLinkSourceQueryItem = "source"
    static let mlxDownloadDeepLinkAutoSelectQueryItem = "autoSelect"
