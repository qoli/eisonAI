...
struct AppConfigDebugView: View {
    ...
    private var defaultsEntries: [DefaultsEntry] {
        [
            ...
            DefaultsEntry(name: "legacyGenerationBackendKey", key: AppConfig.legacyGenerationBackendKey),
            DefaultsEntry(name: "appGenerationBackendKey", key: AppConfig.appGenerationBackendKey),
            DefaultsEntry(name: "extensionGenerationBackendKey", key: AppConfig.extensionGenerationBackendKey),
            ...
            DefaultsEntry(name: "mlxSelectedModelIDKey", key: AppConfig.mlxSelectedModelIDKey),
